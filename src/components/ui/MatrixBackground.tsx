...
export function MatrixBackground() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-black">
      {/* Ultra-subtle elegant top lighting gradient for depth */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(14,165,233,0.08),transparent_70%)]" />
      ...
      {/* Canvas for soft constellation telemetry */}
